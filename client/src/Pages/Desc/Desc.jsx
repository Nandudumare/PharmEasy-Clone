...
const Desc = () => {
  ...
  const getData2 = () => {
    axios
      .get(`https://pharmeasyapi.onrender.com/api/product?q=${detail2}`)
      .then(({ data }) => {
        setSlider(data);
      });
  };
  ...
  const getData = () => {
    axios
      .get(`https://pharmeasyapi.onrender.com/api/product/single/${title}`)
      .then(({ data }) => {
        setDesdata(data);
      });
  };
  ...
  const handleAddToCart = async () => {
    const res = await axios.post("https://pharmeasyapi.onrender.com/api/cart", {
